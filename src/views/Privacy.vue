<template>
    <div class="flex flex-row justify-start px-10 md:px-20 pt-12 items-center">
      <button v-on:click="this.$router.go(-1);">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16l-4-4m0 0l4-4m-4 4h18"/>
        </svg>
      </button>
      <a class="text-xl font-productSans ml-4" v-on:click='this.$router.go(-1);'>返回上一頁</a>
    </div>
    <div class="m-8">
        <p class="text-3xl">Quahk S6E</p>
        <p class="text-3xl">隱私權保護政策</p><br/>
        <p>此版本之隱私權保護政策自二零二二年二月二十五日生效。</p><br/>
        <p>非常歡迎您選擇使用「Quahk S6E」（以下簡稱本系統），為了讓您能夠安心的使用本系統的各項服務與資訊，特此向您說明本系統的隱私權保護政策，以保障您的權益，請您詳閱下列內容：</p><br/>
